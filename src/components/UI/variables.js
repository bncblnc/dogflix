...
export const courseColor3 = "#FFBA05";
export const courseColor4 = "#DC6EBE";
export const courseColor5 = "#9CD33B";
export const courseColor6 = "#6B5BE2";
export const courseColor7 = "#FF8C2A";
